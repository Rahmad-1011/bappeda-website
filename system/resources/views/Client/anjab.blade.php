      ...
      <div class="row">
        <center>
            <div class="col-xl-12 col-lg-12 icon-boxes d-flex flex-column px-lg-5" style="text-align: justify;">
              <h3 style="margin-top: 120px;">ANJAB BAPPEDA Kabupaten Ketapang</h3>
              <div class="row">
              ...
              <div class="col-md-3" style="margin-top: 20px;">
                <div class="card border-0 shadow" style="width: 18rem; height: 16rem;">
                  ...
                  <div class="card-body">
                    <center>
                      <h5 class="card-title">{{$anjab->nama}}</h5>
                    </center>
                  </div>
                      <a href="{{"/public/$anjab->file"}}" class="btn btn-primary"><i class="fa fa-download"></i> Unduh</a>
                </div>
              </div>
              @endforeach
              </div>
