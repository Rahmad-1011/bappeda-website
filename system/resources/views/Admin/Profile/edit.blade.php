...
<div class="row">
  <div class="x_panel">
    <div class="x_title">
      <h2>Edit Profile BAPPEDA Ketapang</h2>
      ...
      <div class="clearfix"></div>
                  ...
                  <div class="x_content">
                      <form method="POST" action="{{url('Admin/profile-bappeda/simpan', $profile->id)}}" enctype="multipart/form-data">
                                      @method("PUT")
                                      @csrf
                                      ...
                                      <div class="item form-group">
                                        <div class="col-md-12 col-sm-12 ">
                                          ...
                                          <textarea style="height: 300px" name="konten" class="form-control">{!!nl2br ($profile->konten) !!}</textarea>
                                        </div>
                                      </div>
