  ...
  <div class="x_panel">
    <div class="x_title">
      ...
      <div class="clearfix"></div>
                  ...
                  <div class="x_content">
                      <form method="POST" action="{{url('Admin/sop/simpan', $sop->id)}}" enctype="multipart/form-data">
                         @method("PUT")
                         @csrf
                         <div class="item form-group">
                           <div class="col-md-12 col-sm-12 ">
                             <label class="col-form-label col-md-12 col-sm-12" for="nama">Nama Bidang
                             </label>
                             <input type="text" id="nama" name="nama" value="{{$sop->nama}}" required="required" class="form-control">
                           </div>
                         </div>
                         <div class="item form-group">
                           <div class="col-md-12 col-sm-12 ">
